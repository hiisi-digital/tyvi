    ...
    if (isPathSeparator(code)) {
      if (lastSlash === i - 1 || dots === 1) {
        ...
        if (
          ...
          res.charCodeAt(res.length - 1) !== CHAR_DOT || res.charCodeAt(res.length - 2) !== CHAR_DOT
        ) {
          if (res.length > 2) {
